...
```sh
pip install git+https://github.com/interopdata/interopdata-python.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/interopdata/interopdata-python.git`)
...
If the OpenAPI document is large, imports in interopdata.apis and interopdata.models may fail with a
RecursionError indicating the maximum recursion limit has been exceeded. In that case, there are a couple of solutions:

Solution 1:
Use specific imports for apis and models like:
- `from interopdata.apis.default_api import DefaultApi`
...
import interopdata
from interopdata.apis import *
from interopdata.models import *
```
